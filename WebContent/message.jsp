...
<% if( sessionUsername != null){%>
	...
	%>						
	<jsp:include page="table_start_title.jsp" flush="true" />
	<% String titleAdmin = "Posted On: " + date_time + "&nbsp;&nbsp;&nbsp;<a href=\"./index.jsp?page=editmessage&forum_id=" + forum_id + "&thread_id=" + thread_id + "&reply_id=" + reply_id + "&start=" + start + "\">Edit</a>&nbsp;&nbsp;&nbsp;<a href=\"action/DeleteReply.jsp?forum_id=" + forum_id + "&thread_id=" + thread_id + "&reply_id=" + reply_id + "&start=" + start + "\">Delete</a>"; %>
	...
	<form action="action/AddReply.jsp" method="POST" name="formmessage">
	...
	<jsp:include page="textStyle.jsp" flush="true" />

	<jsp:include page="table_body.jsp" flush="true">
		<jsp:param name="width" value="200" /> 
	</jsp:include>
	<jsp:include page="emoticons.jsp" flush="true" />
	<jsp:include page="table_close_body.jsp" flush="true" />				 
	<jsp:include page="table_close.jsp" flush="true" />        
...
<% }else { %>
	...
	<jsp:include page="table_start.jsp" flush="true" /> 
	<jsp:include page="table_title.jsp" flush="true">
		<jsp:param name="title" value="Sign up for free" /> 
