...
import forum.AddThread;
import forum.DBConnectie;

import static org.junit.Assert.*;

/**
 * The class <code>AddThreadTest</code> contains tests for the class <code>{@link AddThread}</code>.
 *
...
public class AddThreadTest {
	/**
	 * Run the AddThread() constructor test.
	 *
	 * @generatedBy CodePro at 8/27/15 4:39 AM
	 */
	@Test
	public void testAddThread_1()
		throws Exception {
		AddThread result = new AddThread();
	...
	public void testDoGet_1()
		throws Exception {
		AddThread fixture = new AddThread();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AddThreadTest.class);
	}
}