...
import forum.DeleteForum;

import static org.junit.Assert.*;

/**
 * The class <code>DeleteForumTest</code> contains tests for the class <code>{@link DeleteForum}</code>.
 *
...
public class DeleteForumTest {
	/**
	 * Run the DeleteForum() constructor test.
	 *
	 * @generatedBy CodePro at 8/27/15 4:39 AM
	 */
	@Test
	public void testDeleteForum_1()
		throws Exception {
		DeleteForum result = new DeleteForum();
	...
	public void testDoGet_1()
		throws Exception {
		DeleteForum fixture = new DeleteForum();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(DeleteForumTest.class);
	}
}