...
/**
 * The class <code>LogoutTest</code> contains tests for the class <code>{@link Logout}</code>.
 *
...
public class LogoutTest {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(LogoutTest.class);
	}
}