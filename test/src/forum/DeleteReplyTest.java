...
import forum.DeleteReply;

import static org.junit.Assert.*;

/**
 * The class <code>DeleteReplyTest</code> contains tests for the class <code>{@link DeleteReply}</code>.
 *
...
public class DeleteReplyTest {
	/**
	 * Run the DeleteReply() constructor test.
	 *
	 * @generatedBy CodePro at 8/27/15 4:39 AM
	 */
	@Test
	public void testDeleteReply_1()
		throws Exception {
		DeleteReply result = new DeleteReply();
	...
	public void testDoGet_1()
		throws Exception {
		DeleteReply fixture = new DeleteReply();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(DeleteReplyTest.class);
	}
}