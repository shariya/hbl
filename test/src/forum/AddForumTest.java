...
import forum.AddForum;
import forum.DBConnectie;

import static org.junit.Assert.*;

/**
 * The class <code>AddForumTest</code> contains tests for the class <code>{@link AddForum}</code>.
 *
...
public class AddForumTest {
	...
	/**
	 * Run the AddForum() constructor test.
	 *
	 * @generatedBy CodePro at 8/27/15 4:39 AM
	 */
	@Test
	public void testAddForum_1()
		throws Exception {
		AddForum result = new AddForum();
	...
	public void testDoGet_1()
		throws Exception {
		AddForum fixture = new AddForum();
		fixture.db = new DBConnectie("aa", "bb", "cc");
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AddForumTest.class);
	}
}